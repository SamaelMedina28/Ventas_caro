      ...
      <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
        ...
        <div className="mt-20">
          <ul className="">
            ...
            <ItemFAQ pregunta="¿Cual es la primera pregunta?" respuesta="Respuesta a la primera pregunta" />
            <ItemFAQ pregunta="¿Cual es la segunda pregunta?" respuesta="Respuesta a la segunda pregunta" />
            <ItemFAQ pregunta="¿Cual es la tercera pregunta?" respuesta="Respuesta a la tercera pregunta" />
            <ItemFAQ pregunta="¿Cual es la cuarta pregunta?" respuesta="Respuesta a la cuarta pregunta" />
...
function ItemFAQ({ pregunta, respuesta }: Props) {
  return (
    <motion.li className="text-left mb-10"
    ...
    >
      <div className="flex flex-row items-start mb-5">
        <div
          className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-sky-500/60 text-white border-4 border-white text-xl font-semibold">
        ...
        <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
          <h4 className="text-md leading-6 font-medium text-gray-900">{pregunta}</h4>
        </div>
      </div>

      <div className="flex flex-row items-start">
        <div className="bg-sky-100/60 p-5 px-10 w-full flex items-center">
          <p className="text-gray-700 text-sm">{respuesta}</p>
        </div>
        <div
          className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-sky-500/60 text-white border-4 border-white text-xl font-semibold">
